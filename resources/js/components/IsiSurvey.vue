            ...
            <div class="row mb-2 justify-content-md-center">
                <div class="col-sm-12">
                    <h1 class="m-0">
                        ...
                        <span class="m-0 text-muted" style="font-size:smaller !important;">Kanwil Kemenag Prov Sumatera Barat</span>
    ...
    <div class="content">
        ...
        <div class="qr-code mb-3" style="justify-content: center; text-align: center;">
                ...
                <div class="image-box mb-3">
                    <center>
                    <img src="https://res.cloudinary.com/dezj1x6xp/image/upload/c_limit,h_200,w_200/v1725864352/PandanViewMandeh/QRCode_KemenagSumbar_fbju52.jpg" alt="AdminLTE Logo">
                    </center>
                </div>
