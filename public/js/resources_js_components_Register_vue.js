...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    var schema = yup__WEBPACK_IMPORTED_MODULE_0__.object().shape({
      username: yup__WEBPACK_IMPORTED_MODULE_0__.string().required("Username is required!").min(3, "Must be at least 3 characters!").max(20, "Must be maximum 20 characters!"),
      email: yup__WEBPACK_IMPORTED_MODULE_0__.string().required("Email is required!").email("Email is invalid!").max(50, "Must be maximum 50 characters!"),
      password: yup__WEBPACK_IMPORTED_MODULE_0__.string().required("Password is required!").min(6, "Must be at least 6 characters!").max(40, "Must be maximum 40 characters!")
    });
    return {
      successful: false,
      loading: false,
  ...
  methods: {
    handleRegister: function handleRegister(user) {
      var _this = this;
      this.message = "";
      this.successful = false;
      this.loading = true;
      this.$store.dispatch("auth/register", user).then(function (data) {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <img id=\"profile-img\" src=\"//ssl.gstatic.com/accounts/ui/avatar_2x.png\" class=\"profile-img-card\" /> "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Form, {
    onSubmit: $options.handleRegister,
    "validation-schema": $data.schema
  }, {
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [!$data.successful ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [_hoisted_5, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Field, {
        name: "username",
        type: "text",
        "class": "form-control"
        ...
        name: "email",
        "class": "error-feedback"
      })]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [_hoisted_9, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Field, {
        name: "password",
        type: "password",
        "class": "form-control"
      }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_ErrorMessage, {
      ...
      }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_12, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, $data.loading]]), _hoisted_13], 8 /* PROPS */, _hoisted_11)])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)];
    }),
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["onSubmit", "validation-schema"]), $data.message ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 0,
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["alert", $data.successful ? 'alert-success' : 'alert-danger'])
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.message), 3 /* TEXT, CLASS */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]);
}
